...
namespace OutWeb.Entities
{
    ...
    public partial class WBPRODUCT
    {
        ...
        public int MAP_PRODUCT_TP_ID { get; set; }
        ...
        public string PRD_CONTENT { get; set; }
        public string LANG_CD { get; set; }
        public bool DIS_FRONT_ST { get; set; }
        public int SR_SQ { get; set; }
        public string PRD_TP { get; set; }
        public string PRD_SPE { get; set; }
        public string PRD_MT { get; set; }
        public string PRD_FEAT { get; set; }
    }
}
